...
ALTER TABLE [dbo].[Asistencia] ENABLE TRIGGER [trg_Asistencia_Insert]
GO
...
ALTER TABLE [dbo].[Asistencia] ENABLE TRIGGER [trg_Asistencia_Update]
GO
...
ALTER TABLE [dbo].[Practicante] ENABLE TRIGGER [trg_Practicante_Delete]
GO
...
ALTER TABLE [dbo].[Practicante] ENABLE TRIGGER [trg_Practicante_Insert]
GO
...
ALTER TABLE [dbo].[Practicante] ENABLE TRIGGER [trg_Practicante_Update]
GO
        ...
        @Descripcion = 
            CASE 
                ...
                WHEN ISNULL(i.AreaID, 0) != ISNULL(d.AreaID, 0) THEN 
                    'Area de práctica cambiada: ' + p.Nombres + ' ' + p.ApellidoPaterno
...
ALTER TABLE [dbo].[SolicitudPracticas] ENABLE TRIGGER [trg_SolicitudPracticas_Update]
GO
...
ALTER TABLE [dbo].[Usuario] ENABLE TRIGGER [trg_Usuario_Delete]
GO
...
ALTER TABLE [dbo].[Usuario] ENABLE TRIGGER [trg_Usuario_Insert]
GO
    ...
    SELECT 
        @Descripcion = 
            CASE 
                ...
                WHEN ISNULL(i.AreaID, 0) != ISNULL(d.AreaID, 0) THEN 
                    'Area cambiada para: ' + i.Nombres + ' ' + i.ApellidoPaterno
...
ALTER TABLE [dbo].[Usuario] ENABLE TRIGGER [trg_Usuario_Update]
GO
